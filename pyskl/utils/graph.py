...
class Graph:
    ...
    def random(self):
        A = np.random.randn(self.num_filter, 25, 25) * self.init_std + self.init_off
        A1 = np.random.randn(self.num_filter, 5, 5) * self.init_std + self.init_off
        A2 = np.random.randn(self.num_filter, 12, 12) * self.init_std + self.init_off
        A3 = np.random.randn(self.num_filter, 8, 8) * self.init_std + self.init_off
        return A, A1, A2, A3
